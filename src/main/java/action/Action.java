...
public class Action extends BaseClass implements ActionInterface {
	...
	public void click2(WebElement ele) {
		ele.click();
	}
	...
	public void selectElementFomDD(WebElement ele, String value){
		Select s = new Select(ele);
		s.selectByValue(value);
		
	}
	public void selectByVisibleTextFromDD(WebElement ele,String visibletext) {
		Select s = new Select(ele);
	...
	public void setCheckbox(WebElement ele) {
		if (ele.isEnabled()) {
	...
	public void selectByVisibleTextDD(WebElement ele, String visibletext) {
		// TODO Auto-generated method stub
